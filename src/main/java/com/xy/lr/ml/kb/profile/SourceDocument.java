...
public class SourceDocument {
	 ...
	 * 有参的构造函数
	 * */
	public SourceDocument(String sourceDoc, long sourceDocID, String sourceDocPubtime, String
			sourceDocRealtime, String sourceValue, String sourceVerb) {
	...
	public void setSourceDocument (Element element) {
		this.sourceDoc = element.attributeValue("doc");
		this.sourceDocID = Long.valueOf( element.attributeValue("id") );
		this.sourceDocPubtime = element.attributeValue("pubtime");
		this.sourceDocRealtime = element.attributeValue("realtime");
		this.sourceValue = element.getStringValue();
		this.sourceVerb = element.attributeValue("verb");
	}
